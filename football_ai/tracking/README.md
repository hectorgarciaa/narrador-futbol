...
3. **PnLCalibFieldProjector + gates de relabel a árbitro/portero**: calibra el campo en ese frame y proyecta `player` y `goalkeeper` a coordenadas métricas `[x_m, y_m]` sobre el césped.
