...
from football_ai.positions.data import ROLE_LABELS_V1, find_project_root
from football_ai.positions.model.config import (
    DEFAULT_BASE_TABLE_PATH,
    DEFAULT_MAX_TEAMMATES,
    DatasetBundle,
    TrainingConfig,
)
from football_ai.positions.model.data_utils import (
    FeatureStandardizer,
    RoleDataset,
...
from football_ai.positions.model.training import (
    _classification_metrics,
    _run_epoch,
    select_device as _select_device,
)

from football_ai.positions.model.architecture import (
    MLP,
...
def _build_label_encoder(label_names):
