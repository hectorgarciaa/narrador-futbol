...
**Nota IDs especiales 1-2:** si `tracking.special_seed_role_team_assignment_enabled=true`, `track.py` ejecuta el modelo de roles posicionales al terminar el tracking y usa el defensa más cercano para asignar equipo a esos IDs reservados. Para ellos no se usa color de camiseta como criterio de recuperación.
