...
- `final_train_val/`: entrenamientos finales con la configuración ya seleccionada, usando `train+val` como conjunto de entrenamiento y `test` solo como evaluación final.
