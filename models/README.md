...
│       └── yolov11m/
│           └── weights/
│               └── best.pt      ← modelo fine-tuned de jugadores
└── finetuning-balon/
    └── v11/
        └── yolov11m/
            └── weights/
                └── best.pt      ← modelo fine-tuned de balón
```
...
3. Copiar manualmente al directorio correspondiente:
   ```bash
   # Windows
   copy runs\detect\finetuning\weights\best.pt models\finetuning\v11\yolov11m\weights\best.pt
   ```
