...
Una vez establecido ese contexto, el \hyperref[cap:procesamientoVisual]{Capítulo~\ref*{cap:procesamientoVisual}. Procesamiento Visual} describe la primera gran fase del sistema. En este capítulo se explica cómo se transforma el vídeo broadcast en una representación estructurada del partido mediante detección de elementos del juego, calibración geométrica del campo, clasificación de equipos y tracking temporal de jugadores, árbitros y balón.

Sobre esa salida se construye el \hyperref[cap:analisisTactico]{Capítulo~\ref*{cap:analisisTactico}. Análisis Táctico}, donde se abordan tareas de mayor nivel semántico. En él se describe la inferencia del dueño de la posesión utilizando heurísticas, la inferencia de posiciones futbolísticas a partir de la disposición espacial de los jugadores y la clasificación de acciones relevantes del partido, como pases, controles, robos o tiros.
