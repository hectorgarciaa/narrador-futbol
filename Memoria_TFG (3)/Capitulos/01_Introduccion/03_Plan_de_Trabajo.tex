...
Finalmente, los comentarios generados se transformaron en audio mediante síntesis de voz con XTTS, contemplando la alternancia de voces disponibles para producir una narración más dinámica.
...
\caption[Arquitectura software del pipeline]{Arquitectura software del pipeline del sistema. Se organiza en un bloque síncrono, que agrupa las fases de deteccion, localizacion, tracking y análisis táctico, y un bloque asíncrono, responsable de la narración automática.}
