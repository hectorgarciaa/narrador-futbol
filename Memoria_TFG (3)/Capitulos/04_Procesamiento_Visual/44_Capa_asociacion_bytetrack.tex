...
La configuracion completa de la capa se resume en la \hyperref[tab:hiperparametros-bytetrack]{Tabla~\ref*{tab:hiperparametros-bytetrack}}.
...
La eleccion final de los hiperparametros de esta fase se realizo mediante prueba y error, acumulando muchos experimentos y evaluando su efecto sobre las metricas del sistema; este proceso se describe con mas detalle en la \hyperref[sec:evaluacion-heuristica-depuracion]{Seccion~\ref*{sec:evaluacion-heuristica-depuracion}}.
