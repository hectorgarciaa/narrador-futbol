...
El valor de estos hiperparametros que aparece en la tabla se decidió mediante depuracion iterativa y pruebas visuales sobre vídeo de referencia. Este proceso de depuración se describe en la \hyperref[sec:evaluacion-heuristica-depuracion]{Seccion~\ref*{sec:evaluacion-heuristica-depuracion}}.
...
En la \hyperref[fig:homography_frame]{Figura~\ref*{fig:homography_frame}} se muestra un ejemplo visual de la salida de esta fase para un frame del vídeo de prueba. Las detecciones, puntos y lineas de referencia encontrados se muestran en el panel de la izquierda. Mientras que en la derecha se muestra como quedan ubicados sobre el campo las detecciones trás la homografía. El video del resultado completo se puede encontrar en \url{https://github.com/hectorgarciaa/narrador-futbol/output/homography/best/20260516_180637/homography.mp4}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{Imagenes/Propias/detect_homography.png}
    \caption{Resultado visual de la fase de calibración de campo y proyección}
