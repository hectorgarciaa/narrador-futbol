...
Para construir el conjunto de datos se partió de clips de partidos de aproximadamente 30 segundos de duración (750 frames a 25 FPS). Estos clips no estaban anotados con posiciones futbolísticas ni con identidades de tracking. Es decir, el material de partida consistía únicamente en secuencias de vídeo, sin indicar qué jugador aparecía en cada \textit{bounding box} ni qué rol táctico ocupaba.
