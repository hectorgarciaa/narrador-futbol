...
El término $QK^T$ mide la compatibilidad entre cada consulta y cada clave. La división por $\sqrt{d}$ evita que estos productos escalares crezcan demasiado cuando la dimensión de las claves es grande, lo que podría hacer que la función \textit{softmax} produzca distribuciones excesivamente concentradas. Por eso se denomina atención escalada.
