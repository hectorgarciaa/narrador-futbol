...
\include{Capitulos/01_Introduccion/00_Introduccion}
\include{Capitulos/02_Tecnologias_Utilizadas/20_Tecnologias_utilizadas}
\include{Capitulos/03_Trabajo_Relacionado/30_Trabajo_relacionado}
\include{Capitulos/04_Procesamiento_Visual/40_Procesamiento_visual}
\include{Capitulos/05_Analisis_Tactico/50_Analisis_tactico}
\include{Capitulos/06_Narracion/60_Narracion}
\include{Capitulos/07_Integracion_sistema_validacion/70_Integracion_sistema_validacion}
\include{Capitulos/08_Conclusiones_Trabajo_Futuro}

% Bibliografía
\input{Cascaras/bibliografia}
