...
DEFAULT_OUTPUT_DIR = Path("experiments/positions/grid_search_outputs")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Grid search experimental para el Set Transformer de posiciones. "
            "Todo se guarda dentro de experiments/positions."
        )
    )
